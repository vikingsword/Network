...
# url = "https://wallhaven.cc/search?categories=111&purity=001&topRange=1y&sorting=toplist&order=desc&ai_art_filter=0&page="
# url = "https://wallhaven.cc/search?categories=111&purity=010&topRange=1y&sorting=toplist&order=desc&ai_art_filter=0&page="
# url = 'https://wallhaven.cc/search?categories=111&purity=100&topRange=1y&sorting=toplist&order=desc&ai_art_filter=0&page='
url = 'https://wallhaven.cc/search?categories=111&purity=010&topRange=1y&sorting=toplist&order=desc&ai_art_filter=0&page='
for page in range(1, 2):
    target = url + str(page)
    # print(target)
    soup = getSoup(target)
    # text = soup.find('body', attrs={'class', 'base'}).find('main', id='main')\
    #     .find('div', id='thumbs').find('section', attrs={'class','thumb-listing-page'}).find_all('img',alt='loading')
