...
def insert_records(node_name, start_range, end_range):
    ...
    try:
        ...
        for i in range(start_range, end_range + 1):
            ...
            cursor.execute(sql, (
                count, 1, 0, 0, 0, node_name + str(i) + str("-s"), 1, 0, 20000 + i, "shadowsocks", json.dumps(setting_data1),
            ...
            cursor.execute(sql, (
                count, 1, 0, 0, 0, node_name + str(i) + str("-vm"), 1, 0, 30000 + i, "vmess", json.dumps(setting_data2),
            ...
            cursor.execute(sql3, (
                count, 1, 0, 0, 0, node_name + str(i) + str("-s5"), 1, 0, 40000 + i, "socks", json.dumps(setting_data3),
