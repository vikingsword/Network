...
# 插入记录的函数
def insert_records(node_name, start_range, end_range, method):
    try:
        # 将起始和结束范围转为整数
...
def create_gui():
    ...
    # 方法下拉框
    tk.Label(window, text="加密方法:").pack()
    methods = ["aes-128-gcm", "aes-256-gcm", "chacha20-poly1305", "chacha20-ietf-poly1305"]
    ...
    def on_click():
        ...
        if node_name and start_range.isdigit() and end_range.isdigit():
            insert_records(node_name, start_range, end_range, method)
        else:
